...
public class EmployeeMapper implements ResultSetMapper<Employee> {
  ...
  public final Employee map(final int idx, final ResultSet rs, final StatementContext ctx) throws SQLException {
    ...
    return new Employee(rs.getInt("emp_id"),rs.getString("emp_name"),rs.getLong("emp_mobile"), rs.getString("email"),rs.getString("designation"),rs.getString("department"),rs.getString("user_name"),rs.getString("passwordd"),rs.getInt("mgr_id"),rs.getInt("avail_leave"));
